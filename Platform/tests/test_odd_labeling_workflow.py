...
def test_workflow_interface_does_not_expose_endpoint_url() -> None:
    ...
    assert ODD_LABELER_VERSION == "odd_dataset_labeler_v10"
    assert ODD_SOURCE_POLICY_VERSIONS["map_route"] == "odd_map_route_policy_v2"
    assert ODD_SOURCE_POLICY_VERSIONS["gnss_ins"] == "odd_gnss_ins_policy_v2"
    assert ODD_SOURCE_POLICY_VERSIONS["vlm"] == "odd_road_vlm_policy_v7"
