...
| Console (DataModelConsole) | namespace `console`。Deployment `console-api` (Go, :8080) + `console-web` (Next.js, :3000) 各 replica 2。`console-api@sha256:686e1941e28ba7ac4e763a2c43853ffe1f79bed1adbc7784a66fcd55e37e2c3c` / `console-web@sha256:a17697f6a3b632c4459d1ce49bc229e0ceae0cdc6310f3e5934dc3ae7a021a8e` を 2/2 Ready で稼働。CodeBuild #107 `5c760409-ad03-47f7-8536-8926f0c12ed2`、source commit `6dab9674722541577c22f9cda9420e70e2abc7c1`。`/experiments` の Flyte/MLflow/Registry 横断表示と Full scope 限定表示を desktop・mobile で本番検証済み (2026-07-26)。exact geography は `EXACT_GEO_ENABLED=false` | `kubectl -n console get deploy,ingress` |
